...
/*
 * Shared chrome + honesty primitives for the Intelligence Workspace (Phase 8).
 *
 * Mirrors the published design idiom (restrained borders, surface hierarchy,
 * compact rows) without borrowing Command Center semantics. Every absent state is
 * explained: empty is honest, never dressed as healthy or as data.
 */
...
/** Calm marker that content is non-authoritative / advisory (design honesty). */
export function AdvisoryMarker({ label = "Advisory" }: { label?: string }) {
  return (
