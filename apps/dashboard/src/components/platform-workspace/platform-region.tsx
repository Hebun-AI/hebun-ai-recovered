...
/*
 * Shared chrome + honesty primitives for the Platform Workspace (Phase 13).
 *
 * Technical, structured, dependency-aware identity — distinct from Operations
 * (live work), Governance (control), and Command (executive). Uses the published
 * design system. Every absent state is explained; empty is honest, unavailable is
 * never shown as available, and no secret is ever rendered.
 */
...
/** Calm marker that a surface is a non-authoritative technical view. */
export function TechnicalMarker({ label = "Technical view" }: { label?: string }) {
  return (
