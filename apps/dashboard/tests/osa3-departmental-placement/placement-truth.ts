...
async function main(): Promise<void> {
  ...
  assert.equal(HEBY_SOURCE_CLASSES.length, 21, "the census is twenty-one — placement was the 19th, OSA-4's `people` the 20th, SOC-ACT1's `provider-observations` the 21st");
