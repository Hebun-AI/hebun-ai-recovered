...
function main(): void {
  ...
  assert.deepEqual(
    ...
    'governance subject types are exactly ["knowledge_node", "work_artifact_revision", "media_asset"] — a read seam adds no Governance subject',
  );
  assert.ok(
