...
const LEDGER_DIGEST = "cbf6c4bb4eda57cc"; /* MEDIA-2A authored migration 57 (live image transport provenance); the digest moved with it. */ /* CGO-1 authored a migration — the `content-draft` type and its declared destination — so the ledger digest moved with it.
