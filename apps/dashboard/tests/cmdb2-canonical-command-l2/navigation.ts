...
const LEDGER_DIGEST = "13717f4fff044119"; /* CGO-1 authored a migration — the `content-draft` type and its declared destination — so the ledger digest moved with it.
