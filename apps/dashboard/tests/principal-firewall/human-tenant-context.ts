...
function main(): void {
  ...
  assert.equal(sqlCount, 46, "this phase authored no migration — a type needs none"); /* WEV-1 grew the ledger 44 -> 45; PBGA-1 45 -> 46 (`heby_action_requests` purpose columns). */
