...
function main(): void {
   ...
   * ═════════════════════════════════════════════════════════════════════ */
  {
    ...
    assert.equal(
      ...
      /* MV-2 holds the newest line now; MEDIA-SUPPLIED held it before. */ "20260926083521_mv2_media_video_kind",
