...
function main(): void {
   ...
   * ═════════════════════════════════════════════════════════════════════ */
  {
    ...
    assert.equal(
      ...
      "and the Media Asset authority holds the newest line — RUNG 2's standing mutation authority held it before, the RUNG 2 prerequisite before that, and TRH-19 before that",
    );
