...
function main(): void {
   ...
   * ═════════════════════════════════════════════════════════════════════ */
  {
    ...
    assert.equal(
      ...
      "and the RUNG 2 standing mutation authority holds the newest line — the RUNG 2 prerequisite held it before, self-service signup before that, and TRH-19 before that",
    );
