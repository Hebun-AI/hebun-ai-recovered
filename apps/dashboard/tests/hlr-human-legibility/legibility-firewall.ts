 ...
 * ═══════════════════════════════════════════════════════════════════════════ */
{
  ...
  assert.equal(migrations.length, 44, "the migration ledger is untouched by HLR"); /* WORK-1 grew it to 42; Departmental Placement to 43; GIA-1 to 44. None is HLR's. */
