  ...
  try {
     ...
     */
    {
      ...
      assert.equal(
        ...
        /* MV-5: 65 -> 66 appended; the first 65 files still digest to the MV-4 values. */ /* MV-4: 64 -> 65 appended; the first 64 files still digest to the MV-2 values. */ /* MV-2: one appended migration (63 -> 64), so the release digest moved from 71058586…. */ "51a288a38d93d55448491ae797ca83a0",
        /*
