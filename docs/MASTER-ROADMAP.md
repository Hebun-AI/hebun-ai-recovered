...
**NONE SELECTED.** Era II is **OPEN** with **no active milestone**. E2-4, E2-5, E2-6 and E2-7 are all **PRODUCTION-ACCEPTED**; **no E2-8 is opened, and no closure schedules ASA-2.**
